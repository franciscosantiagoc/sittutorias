            ...
            <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown menu">
                    ...
                    <div class="dropdown-menu" role="menu">
                        ...
                        <a class="dropdown-item" role="presentation" href="CordCarrera/ActividadesC.html">Gestión de Actividades</a>
                    </div>
                </li>
                <li class="nav-item dropdown show menu">
                    <a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false">Tutor</a>
                    <div class="dropdown-menu" role="menu">
