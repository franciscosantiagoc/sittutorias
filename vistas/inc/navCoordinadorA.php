    ...
    <div class="container-fluid">
        ...
        <div
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item dropdown menu"><a class="dropdown-toggle nav-link menu" data-toggle="dropdown" aria-expanded="false" href="#" style="color: #ffffffff;"><img class="rounded-circle" id="img-perfil" src="<?php $_SESSION['imgperfil_sti'];?>"></a>
