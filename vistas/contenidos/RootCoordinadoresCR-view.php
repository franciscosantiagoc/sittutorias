...
?>
                 ...
                 <div class="form-container">
                     <form method="post">
                         <div class="form-group">
                             <label for="rootccarrera">Ingrese Nombre/Matrícula</label>
                             <input type="text" id="rootccarrera" name="rootccarrera" list="lista-tutores">
 ...
 <div class="modal" id="modalListCCarrera" tabindex="-1" role="dialog" aria-hidden="true">
     <div class="modal-dialog modal-dialog-centered" role="document">
         <div class="modal-content">
             ...
             <div class="modal-body">
                 <div class="form-container">
                     <form action="<?php echo SERVERURL;?>FormatRootCoordinadoresCR" method="post">
                         <div class="form-group">
 ...
 <script type="text/javascript">
     ...
     function clickActCCarrera(idActCCarrera){//1 - ver 2- actualizar
         ...
         datos.append("idInfoCCarrera",idActCCarrera);
