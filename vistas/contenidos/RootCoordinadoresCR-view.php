    ...
    <div class="register-photo">
        <div id="importcsvregis" class="form-container">
            <form id="regisTutcsv" method="post">
                ...
                <div class="form-group"><button class="btn btn-primary btn-block" type="submit" ><a href="<?php echo SERVERURL;?>Registro">REGISTRAR</a></button></div><div class="team-boxed">
    <div class="container">
        <div class="intro">
