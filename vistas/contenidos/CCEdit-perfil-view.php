...
if(isset($_SESSION['roll_sti'])){
    if($_SESSION['roll_sti'] != "Coordinador De Carrera" && $_SESSION['roll_sti'] != "Admin" ){
    ...
    <div class="register-photo">
        <div class="form-container">
            <form  class="FormularioAjax" action="<?php echo SERVERURL; ?>ajax/usuarioAjax.php"  method="POST" data-form="update" autocomplete="off">
                ...
                <div class="form-group"><input class="form-control" type="tel" pattern="[0-9()+]{8,20}" placeholder="Número de Telefono" name="numero_tel_upd"></div>
                ...
                <div class="form-group"><input class="form-control" type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,35}" name="carrera_upd" placeholder="Area"></div>
                <div class="form-group"><input class="form-control" type="text" pattern="[0-9-]{8,10}" placeholder="Matrícula" name="no_ctrl_upd"></div>
