                    ...
                    <div class="table-responsive table-bordered table table-hover table-bordered results">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <?php
                                    echo '<tr>
                                        <td>'.$dat_notif['idNotif'].'</td>
                                        <td>'.$dat_notif['Mensaje'].'</td>
                                        <td>'.$dat_notif['Fecha'].'</td>
                                        <td>
                                            <abbr title="Click para eliminar la notificacion">
                                            <button class="btn btn-danger" style="margin-left: 5px;" type="submit"><i class="fa fa-trash" style="font-size: 15px;"></i></button></abbr></td>
                                    </tr>';
                                ?>
                            </tbody>
                        </table>
