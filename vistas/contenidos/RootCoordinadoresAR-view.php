    ...
    <div class="register-photo">
        <div id="importcsvregis" class="form-container">
            <form id="regisTutcsv" method="post">
                ...
                <div class="form-group"><a href="../Registro.html"><button class="btn btn-primary btn-block" type="submit" style="background-color: rgb(245,124,56);">rEGISTRAR</button></a></div><div class="team-boxed">
    <div class="container">
        <div class="intro">
        ...
        <div class="row people">
            <div class="col-md-6 col-lg-4 item">
                <div class="box"><img class="rounded-circle img-person" src="vistas//assets/img/1.jpg" />
            ...
            <div class="col-md-6 col-lg-4 item">
                <div class="box"><img class="rounded-circle img-person" src="vistas//assets/img/2.jpg" />
            ...
            <div class="col-md-6 col-lg-4 item">
                <div class="box"><img class="rounded-circle img-person" src="vistas//assets/img/3.jpg" />
