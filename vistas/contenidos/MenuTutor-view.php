    ...
    <div class="container" id="container-alummenu">
        ...
        <div class="row" id="row">
            ...
            <div class="col"><a href="VistaTutores/informationT.php"><img style="background-image: url(vistas/assets/img/Icons/information.png);background-size: cover;background-position: center;display: block;margin: auto;width: 200px;height: 200px;"></a>
