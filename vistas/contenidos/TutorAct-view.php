    ...
    <div class="container" id="contain">
        <div class="col-md-12 search-table-col">
            ...
            <?php
                        ...
                        $actividades = $ins_consulta->datos_usuario_controlador("Consulta","","SELECT aa.Estatus,a.Nombre AS Activity,DATE_FORMAT(aa.Fecha,'%d-%m-%y'),CONCAT(p.Nombre,' ',p.APaterno,' ',p.AMaterno) AS Nombre, t.NControl, aa.Actividades_idActividades as idAct
                                    FROM trabajador_tutorados tt, actividades_asignadas aa, actividades a, tutorado t,persona p 
                        WHERE tt.Trabajador_Matricula=$matricula AND aa.Tutorado_NControl=tt.Tutorado_NControl AND a.idActividades=aa.Actividades_idActividades 
                        AND t.NControl=tt.Tutorado_NControl AND p.idPersona=t.Persona_idPersona ORDER BY aa.Estatus, Fecha;");
