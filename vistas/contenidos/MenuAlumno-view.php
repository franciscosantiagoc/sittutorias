    ...
    <div class="container" id="container-alummenu">
        ...
        <div class="row" id="row">
            ...
            <div class="col"><a href="contenidos/AlumnSolic-view.php"><img style="background-image: url(&quot;assets/img/Icons/solicitudes.png&quot;);background-size: cover;background-position: center;display: block;margin: auto;width: 200px;height: 200px;"></a>
