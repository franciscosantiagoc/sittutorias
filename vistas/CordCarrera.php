...
<body>
    ...
    <?php include "inc/navCoordinadorC.php" ?>
    ...
    <div class="container" id="container-alummenu">
        ...
        <div class="row" id="row">
            ...
            <div class="col"><a href="CordCarrera/AsignacionTutorado.html"><img id="imgactivities" style="background-repeat: no-repeat;background-size: cover;background-position: center;display: block;margin: auto;width: 200px;height: 200px;background-image: url(&quot;assets/img/Icons/asignacion-tutorado.png&quot;);"></a>
