...
// Metodo para busqueda de jefes de departamento
function doSearchJD() {
    const tableReg = document.getElementById("tabla_tutores");
...
// Metodo para busqueda coordinadores de carrera
function doSearchCC() {
    const tableReg = document.getElementById("tabla_tutores");
...
// Metodo para busqueda tutorados - CCTutorados
function doSearchCCTdos() {
...
// Metodo para busqueda tutores - CCTutores
function doSearchCCTres() {
    const tableReg = document.getElementById("tabla_tutores");
...
function doSearchCCActividades() {
    const tableReg = document.getElementById("tabla_ccactvidades");
