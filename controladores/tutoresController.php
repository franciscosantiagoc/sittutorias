...
class tutoresController extends usuarioModel
{
    ...
    {
        $matricular = mainModel::limpiar_cadena($_POST['act_matricula_rjdepto']);
        $matricula = mainModel::limpiar_cadena($_POST['act_matricula_jepto']);
        $nombre = mainModel::limpiar_cadena($_POST['act_nombre_jdepto']);
        $apellido_paterno = mainModel::limpiar_cadena($_POST['act_apellidop_jdepto']);
        $apellido_materno = mainModel::limpiar_cadena($_POST['act_apellidom_jdepto']);
        $sexo = mainModel::limpiar_cadena($_POST['act_sexo_jdepto']);
        $num_tel = mainModel::limpiar_cadena($_POST['act_tel_jdepto']);
        $email = mainModel::limpiar_cadena($_POST['act_email_jdepto']);
        $area = mainModel::limpiar_cadena($_POST['act_area_jdepto']);
